...
SECRET_KEY = 'django-insecure-zn_zt6o8&hp$_1700lh055vo6mb9f=51-fgh7)#$9d$84k$%q9'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'taarifa_db'),
        'USER': os.environ.get('DB_USER', 'postgres'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'Lema12345'),
...
# Disable CSRF for API endpoints (since we're using JWT/auth tokens)
